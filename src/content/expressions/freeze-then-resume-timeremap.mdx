...
annotations:
  - lines: "1-4"
    ...
    description: "Reads freeze window start/end (seconds) and an optional preroll offset (frames) from the `CONTROL` layer."
  - lines: "6-8"
...
1. Add a `CONTROL` layer with three controls:
