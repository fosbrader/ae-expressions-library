...
annotations:
  ...
  - lines: "10-11"
    title: "Mode Mapping"
    description: "Maps dropdown indices 1–4 to After Effects loop types: cycle, pingpong, offset, continue. Index clamping prevents invalid selections."
  - lines: "13"
...
1. Create or reuse a `CTRL` layer with:
